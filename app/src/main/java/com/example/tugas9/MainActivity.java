...
//setup view binding
        ...
        public void getData() throws MalformedURLException {
            Uri uri = Uri.parse("https://c531-101-128-83-
            56.ap.ngrok.io/api/products")
                    .buildUpon().build();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dl.addDrawerListener(abdt);abdt.syncState();
...
//for storing new data or update data
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ContentValues cv = new ContentValues();
                cv.put("name",binding.edtname.getText().toString());cv.put("star",binding.edtstar.getText().toString());
                cv.put("price",binding.edtprice.getText().toString());
                cv.put("avatar", imageViewToBy(binding.edtimage));
                sqLiteDatabase = dBmain.getWritableDatabase();
            ...
            case MY_CAMERA_REQUEST_CODE: {
                if (grantResults.length > 0) {
                    ...
                    if (camera_accepted && storage_accepted) {
                        ...
                        Toast.makeText(this, "enable camera and
